...
fcn_helpInsert_NullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  addu $sp,$sp,0
  li $s6,3
...
fcn_isBlack_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  addu $sp,$sp,0
  lw $t0,24($sp)
  ...
  addu $sp,$sp,4
  jr $ra
fcn_setBlack_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  lw $t0,24($sp)
  subu $sp,$sp,4
...
# IdentifierExp Assignment: Assign at 140.10; stackHeight = 8
  ...
  addu $sp,$sp,4
  jr $ra
fcn_setRed_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  lw $t0,24($sp)
  subu $sp,$sp,4
...
fcn_helpInsert_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  subu $sp,$sp,4
  sw $s2,($sp)
...
fcn_lookup_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  li $t0,1
  subu $sp,$sp,4
...
fcn_helpDelete_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  subu $sp,$sp,4
  sw $0,($sp)
...
fcn_adjustAfterDelete_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  subu $sp,$sp,4
  sw $s2,($sp)
...
fcn_asNonNull_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  addu $sp,$sp,0
  subu $sp,$sp,4
...
fcn_getRight_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  lw $t0,4($sp)
  subu $sp,$sp,4
...
fcn_getLeft_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  addu $sp,$sp,0
  subu $sp,$sp,4
...
sw $t0,($sp)
  ...
  addu $sp,$sp,4
  jr $ra
fcn_setRight_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  lw $t0,4($sp)
  subu $sp,$sp,4
...
if_done_759:
  ...
  addu $sp,$sp,4
  jr $ra
fcn_setLeft_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  subu $sp,$sp,4
  sw $s2,($sp)
...
fcn_rebalanceAfterInsert_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  subu $sp,$sp,4
  sw $s2,($sp)
...
if_done_908:
  ...
  addu $sp,$sp,4
  jr $ra
fcn_helpPrint_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  lw $t0,8($sp)
  subu $sp,$sp,4
...
if_done_963:
  ...
  addu $sp,$sp,4
  jr $ra
fcn_helpPrintIndent_NonNullRedBlackTree:
  subu $sp,$sp,4
  sw $ra,($sp)
  lw $t0,8($sp)
  subu $sp,$sp,4
